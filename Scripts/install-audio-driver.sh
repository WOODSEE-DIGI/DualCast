...
cd "$PROJECT_ROOT"
xcodebuild -scheme DualCastAudioDriver -configuration Debug -derivedDataPath "$DERIVED_DATA" -allowProvisioningUpdates build >/tmp/dualcast-audio-driver-build.log 2>&1
